    ...
    function printNav($type = 'default'){
        ...
        <div class="wrap">
            ...
            <div class="navi-links">
                <ul class="navi-links_list">
                    <li class="item">
                        <a href="'.$prefix.'/">Главная</a>    
                    </li>
                    <li class="item">
                        <a href="'.$prefix.'/about.php">О нас</a>    
                    </li>
                    <li class="item">
                        <a href="'.$prefix.'/services.php">Услуги</a>
                    </li>
                    <li class="item">
                        <a href="'.$prefix.'/contacts.php">Контакты</a>
                    </li>
                </ul>
            </div>
        </div>
